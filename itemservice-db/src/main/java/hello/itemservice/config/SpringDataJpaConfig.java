...
public class SpringDataJpaConfig {
    ...
    private final SpringDataJpaItemRepository springDataJpaItemRepository;   //EntityManager 참조변수 선언
    ...
    public ItemRepository itemRepository() {
        return new JpaItemRepositoryV2(springDataJpaItemRepository);   //의존성 주입
    }
